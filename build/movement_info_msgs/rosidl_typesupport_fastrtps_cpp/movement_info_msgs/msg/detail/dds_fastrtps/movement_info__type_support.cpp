...
#include "movement_info_msgs/msg/detail/movement_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = movement_info_msgs::msg::MovementInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const movement_info_msgs::msg::MovementInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<movement_info_msgs::msg::MovementInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MovementInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const movement_info_msgs::msg::MovementInfo *>(
...
static size_t _MovementInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MovementInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MovementInfo__callbacks = {
...
static rosidl_message_type_support_t _MovementInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MovementInfo__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_movement_info_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<movement_info_msgs::msg::MovementInfo>()
{
  return &movement_info_msgs::msg::typesupport_fastrtps_cpp::_MovementInfo__handle;
}
